...
with open(
    "/Users/soeon/Desktop/GCU/25/1st_Sem/ReadingAssistance(llm)/demo_ver/RAG/Dataset/tagged_woodcutter_chunks_with_embeddings.json",
    "r",
    encoding="utf-8",
) as f:
...
with open(
    "/Users/soeon/Desktop/GCU/25/1st_Sem/ReadingAssistance(llm)/demo_ver/RAG/Dataset/tagged_woodcutter_chunks.json",
    "r",
    encoding="utf-8",
) as f:
    chunks = json.load(f)
